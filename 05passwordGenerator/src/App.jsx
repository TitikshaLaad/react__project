...
()=>{
  ...
  return (
    ...
    <div className="flex shadow text-center 
      rounded-lg overflow-hidden m-4 px-3 "> 
       ...
       className="outline-none bg-blue-700 text-white px-3 py-0.5 shrink-0 rounded">copy</button>
